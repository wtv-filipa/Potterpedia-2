...
import BannerCharacter from "../../components/FavoritesInd/BannerCharacters";
import Loading from "../../components/Loading";
import Character from "../../components/FavoritesInd";
            ...
            <section className="pb-5">
              <div className="container pt-5">
                <div className="text-right">
                  ...
                  <i
                    onClick={buttonDesc}
                    className="fas fa-sort-alpha-down-alt fa-lg"
                    style={{ color: "black", cursor: "pointer" }}
                  ></i>
                </div>
                <div className="row">
